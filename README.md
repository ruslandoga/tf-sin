...
$ docker run -d --restart always --network host --name test3 \
  ...
  -e "AWS_ACCESS_KEY_ID=${AWS_ACCESS_KEY_ID}" -e "AWS_SECRET_ACCESS_KEY=${AWS_SECRET_ACCESS_KEY}" -e "AWS_S3_BUCKET=${AWS_S3_BUCKET}" -e "AWS_S3_BUCKET_STATIC=${AWS_S3_BUCKET_STATIC}" -e "STATIC_CDN=${STATIC_CDN}" -e "AWS_S3_BUCKET_MEDIA=${AWS_S3_BUCKET_MEDIA}" -e "MEDIA_CDN=${MEDIA_CDN}" -e "AWS_S3_BUCKET_EVENTS=${AWS_S3_BUCKET_EVENTS}" \
